...
import com.pab.it_carreers_catalog.databinding.ActivityDataScientistBinding

class DataScientistActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val fragments = listOf(
            DataScientistPageFragment.newInstance("overview"),
            DataScientistPageFragment.newInstance("skills"),
            DataScientistPageFragment.newInstance("careers")
        )
