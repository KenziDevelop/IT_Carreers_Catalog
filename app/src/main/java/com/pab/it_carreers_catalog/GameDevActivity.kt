...
import com.pab.it_carreers_catalog.databinding.ActivityGameDevBinding
...
class GameDevActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val fragments = listOf(
            GameDevPageFragment.newInstance("overview"),
            GameDevPageFragment.newInstance("skills"),
            GameDevPageFragment.newInstance("careers")
        )
