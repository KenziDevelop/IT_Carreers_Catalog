...
import com.pab.it_carreers_catalog.databinding.ActivityCloudEngineerBinding

class CloudEngineerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val fragments = listOf(
            CloudEngineerPageFragment.newInstance("overview"),
            CloudEngineerPageFragment.newInstance("skills"),
            CloudEngineerPageFragment.newInstance("careers")
        )
