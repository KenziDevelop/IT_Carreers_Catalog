...
import com.pab.it_carreers_catalog.databinding.ActivityDataAnalystBinding

class DataAnalystActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val fragments = listOf(
            DataAnalystPageFragment.newInstance("overview"),
            DataAnalystPageFragment.newInstance("skills"),
            DataAnalystPageFragment.newInstance("careers")
        )
